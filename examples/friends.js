  ...
  Playbook((alice, bob) => [
    {
      ...
      test: (sbot, done) => {
        util.promisify(sbot.friends.hops)(alice.id).then(aliceFollows => {
    ...
    },
    {
      ...
      test: (sbot, done) => {
        Promise.all([
          util.promisify(sbot.friends.hops)(alice.id),
          util.promisify(sbot.friends.hops)(bob.id)
